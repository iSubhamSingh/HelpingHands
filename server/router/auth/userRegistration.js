...
router.post("/", async (req, res) => {
    try {
        ...
        if (type == "volunteer") {
            ...
            <p>Thank you for joining HelpingHands as a volunteer! We are thrilled to have you on board and appreciate your commitment to making a positive impact in our community.
            ...
            <p>Thank you once again for joining HelpingHands. We are excited to work together towards creating a more compassionate and resilient community.</p>
            
            <p>Best regards,</p>
            <p>The HelpingHands Team</p>
            `;

            await sendMail({ email, name, subject: "Thank you for joining HelpingHands", message: messageVolunteer });
