...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    <p>We wanted to inform you that <strong>${name}</strong> has made a generous donation of <strong>${quantity}</strong> cloth(s) through HelpingHands. Your assistance as a registered volunteer is highly valued, and we kindly request your support in facilitating the donation process.</p>
    ...
    <p><strong>The HelpingHands Team</strong></p>
  `;
    ...
    const messageDonor = `
      ...
      <p>Thank you for donating ${quantity} cloth(s) through HelpingHands. Your contribution will make a difference in someone's life.</p>
