...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    const messageDonor = `
      ...
      <p>Thank you for registering as a blood donor with HelpingHands. Your willingness to donate blood can save lives and make a significant impact on those in need.</p>
