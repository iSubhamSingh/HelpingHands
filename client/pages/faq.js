...
function faq() {
    const faqList = [
        {
            title: "What is HelpingHands?",
            content: " HelpingHands is a web application that connects donors with people in need. It serves as a platform bridging the gap between willing donors and those who require assistance. Our goal is to facilitate donations while maintaining trust and ensuring 100% transparency."
        },
        {
            title: "How does HelpingHands work?",
            content: "HelpingHands allows donors to fill out a form and provide their location, enabling us to match them with nearby volunteers through geolocation. We also offer a secure online donation option through a payment gateway, ensuring the safety of transactions. Please be aware that the payment gateway's KYC is currently under test mode, so UPI QR codes are displayed temporarily."
        },
        
        {
            title: "How can I get involved with HelpingHands?",
