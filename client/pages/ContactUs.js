            ...
            <section className=" flex flex-wrap mx-10 mt-24 justify-between items-center">
                <div className="">
                    <div className="mb-12 max-w-[570px] lg:mb-0">
                        <h2
                            className="text-blue-800 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                        >
                            GET IN TOUCH WITH US
                        </h2>
                        <p className="text-body-color mb-9 text-base leading-relaxed">
                            We are always ready to solve your quries, we are 100% transparent charity NGO , feel free to ask for any kind of questions regarding how we collect and distribute , how to ensure that our words are really true.
                        </p>
                        ...
                        <div className="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div className="w-full">
                                ...
                                <p className="text-body-color text-base">(+91) 9876543210</p>
                            </div>
                        </div>
                        <div className="mb-8 flex w-full max-w-[370px]">
                            <div
                            ...
                            <div className="w-full">
                                ...
                                <p className="text-body-color text-base">subhamsingh5638@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="lg:w-[28rem] w-full p-8 my-10 bg-white rounded-xl shadow-xl shadow-blue-200">
                    ...
                    <form action="" className="mt-10">
                        <div className="flex flex-col space-y-5">
                            ...
                            <label htmlFor="email">
                                <span className="font-medium text-slate-700 pb-2">Email</span>
                                <input
                                    onChange={handleInput}
                                    value={query.email}
                                    id="email"
                            ...
                            <label htmlFor="phone">
                                <span className="font-medium text-slate-700 pb-2">Phone</span>
                                <input
                                    onChange={handleInput}
                                    value={query.phone}
                                    id="phone"
                            ...
                            <label htmlFor="message">
                                ...
                                <textarea
                                    ...
                                    name="message"
                                    className="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow"
                                    placeholder="write your message , we'll be more than happy to response..."
                                />
